		...
		this.each(function(){
			...
			function stopEventPropagation( e ){
				if ( e.stopPropagation && e.preventDefault ) {
					...
					if ($(e.target).next().hasClass('levelHolderClass')) {
						e.preventDefault();
					}
				}
				else {
			...
			function updateNestedDOMStructure( $wrapper ){
				...
				$.each( $wrapper, function(){
					...
					$title.attr( { "style" : "text-align: " + ( ( instance.settings.direction == 'rtl' ) ? "left" : "right"  ) } );
					...
					$.each($itemGroup.children( 'li' ), function(){
						var $item = $( this );
						$item.attr( { "style" : "text-align: " + ( ( instance.settings.direction == 'rtl' ) ? "left" : "right" ) } );
